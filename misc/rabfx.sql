...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 28, 2020 at 01:20 PM
...
INSERT INTO `kwitansi` (`noKwitansi`, `jumlahBayar`, `sisaBayar`, `kdProyek`, `kdKonsumen`, `noSPH`) VALUES
('KW01', 32500000000, 22148950000, 'B101', 'K001', 'SPH001');
...
CREATE TABLE `riwayatkwitansi` (
  ...
  `noKwitansi` varchar(6) NOT NULL,
  `bayarNya` double NOT NULL DEFAULT 0,
  `menyerahkan` varchar(20) NOT NULL,
  `menerima` varchar(20) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `riwayatkwitansi`
--

INSERT INTO `riwayatkwitansi` (`tglKwitansi`, `noKwitansi`, `bayarNya`, `menyerahkan`, `menerima`) VALUES
('2020-06-28', 'KW01', 5175525000, 'Suwandi Hidayat', 'Agustyo Pramono');

--
-- Triggers `riwayatkwitansi`
--
DELIMITER $$
CREATE TRIGGER `updateSisaKwitansi` AFTER INSERT ON `riwayatkwitansi` FOR EACH ROW UPDATE kwitansi SET kwitansi.sisaBayar = (kwitansi.sisaBayar - NEW.bayarNya) WHERE kwitansi.noKwitansi = noKwitansi
$$
DELIMITER ;
...
CREATE TABLE `sph` (
  `noSPH` varchar(6) NOT NULL COMMENT 'Nomor Surat Penawaran harga',
...
--
-- Dumping data for table `sph`
--

INSERT INTO `sph` (`noSPH`, `jasa`, `ppn`, `GrandTotal`, `kdProyek`) VALUES
('SPH001', 25000000000, 10, 32500000000, 'B101');
